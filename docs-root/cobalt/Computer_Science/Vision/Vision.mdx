...
## Core Functionality
  ...
  * There is one vision node spawned for each task required to be performed using the [vision.launch](https://github.com/PalouseRobosub/robosub/blob/master/launch/vision.launch) file. For more information on using this launch file, see [[cs:vision:start#Running the Vision System in ROS|Running the Vision System in ROS]] below.
