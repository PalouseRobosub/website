...
The full list of keybindings used in sloth can be found in the [robosub_config.py](https://github.com/PalouseRobosub/vision_dev/blob/master/sloth/robosub_config.py) file near the bottom. A shorthand list is provided below
