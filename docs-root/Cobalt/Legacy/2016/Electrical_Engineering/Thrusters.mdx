...
Official documentation can be found on the [BlueRobotics website](http://docs.bluerobotics.com/bluesc/). The most pertinent information is copied here for quick reference. There are two cables coming off of them. The thicker cable is power, and the smaller cable is signalling.
