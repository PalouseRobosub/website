...
The easiest way with multiple files is to install [pandoc](http://www.pandoc.org). This is a cross-platform CLI tool. With it installed run the following command:
...
This is by no means a comprehensive tutorial of the Wrap plugin. If you want to see all that is possible by default from wrap see this [image](https://www.dokuwiki.org/_media/plugin:wrap_plugin_example9.png). If you have an idea for a custom Wrap class post in the [[slack\>it|IT slack channel]].